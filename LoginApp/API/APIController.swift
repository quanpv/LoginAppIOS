...
//  LoginApp
//
//  Created by Quan Pham Van on 7/25/18.
...
class APIController {
   ...
   class func requestHttp<T : Decodable>(_ url:String,  completionClosure: @escaping ObjectClosure<T>) {
        Alamofire.request(url).responseData() {
            ...
            case let .success(data):
                do {
                    ...
                    completionClosure(responseData)
                } catch let error {
